import { Divider, Input, MultiSelect, RangeSlider } from "@mantine/core";
        ...
        <div className="px-6 py-1 ">
            ...
            <div className="mt-10 flex items-center gap-4 justify-between">
                <div className="flex items-center ">
                    <div><IconUserCircle size={20} className="text-bright-sun-400 bg-mine-shaft-900 rounded-full p-1 mr-2 " /></div>
